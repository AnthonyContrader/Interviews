...
export class RecruiterComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.recruiterService
            ...
            .subscribe(
                (res: HttpResponse<IRecruiter[]>) => this.paginateRecruiters(res.body, res.headers),
    ...
    trackId(index: number, item: IRecruiter) {
        return item.id;
    }
    ...
    private paginateRecruiters(data: IRecruiter[], headers: HttpHeaders) {
