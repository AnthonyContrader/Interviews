...
describe('Service Tests', () => {
    describe('Recruiter Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(RecruiterService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'interviews1/api/recruiters';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Recruiter', () => {
                service.create(new Recruiter(null)).subscribe(received => {
            ...
            it('should update a Recruiter', () => {
                service.update(new Recruiter(123)).subscribe(received => {
